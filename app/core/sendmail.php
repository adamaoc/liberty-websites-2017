...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $mail->SetFrom('contact@liberty-websites.com', 'Liberty Websites Contact form');
    $address = 'adamaoc@gmail.com'; // to address //
    $mail->AddAddress($address, "Liberty-Websites");
    $mail->Subject = "Liberty-Websites form submission | " . $name;
