...
<div class="container">
  <div class="row">
    ...
    <div class="max-width">
      <p>At Liberty-Websites, we know not everyone is backed by a multimillion dollar Super PAC so we want to make it as cheap and easy to get started as possible. All of our packages include at least one scheduled one-on-one consultation to help share our knowledge with you. Web sites are based on the WordPress platform, unless otherwise specified with the Platinum package, and we provide an introduction video to help get you started off right!</p>
